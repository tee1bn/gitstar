...
$admin_images =  $this->domain.'/public/files/admins/';
...
<link rel="shortcut icon" href="<?php echo $admin_image_asset; ?>logo.png" />
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a style="text-transform: capitalize;" href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?=$this->domain;?>/public/img/user.png" alt=""> 
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="<?php echo $this->domain ;?>/admin_auth/logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
