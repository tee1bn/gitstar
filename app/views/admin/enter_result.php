...
<div class="right_col" role="main">
  <div class="">
    ...
    <form id="fixture_form" id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
...
}else if((away_score == home_score) && ( (away_score != null) && (home_score != null))){
    result = 'xx';
    ...
    '<div class="col-md-12 col-sm-12 col-xs-12"> '+  
     '             <div class="input-group"> '+  
            '            <div class="input-group-addon"><span class="badge"> '+i+' </span></div> '+  
                   '     <div class="input-group-addon" style="width:40%;"> '+home_team+'</div> '+  

 ' <input type="number" name="fixture['+i+'][home_score]" value="'+home_score+'"  min="0" max="10" class="form-control input-group-addon" placeholder="score" value=""> '+  
       '            <div class="input-group-addon"><span class="badge"> vs </span></div> '+  
 ' <input type="number" name="fixture['+i+'][away_score]" value="'+away_score+'" min="0" max="10" class="form-control input-group-addon" placeholder="score" value="">'+ 
                '            <div class="input-group-addon" style="width:40%;">'+away_team+'</div> '+  
...
dataString = $("#fixture_form").serialize() ;
  ...
  $.ajax({
      type: "POST",
      url: "<?=$this->domain;?>/admin_save/save_fixture_result",
