...
class User extends Eloquent 
{
    ...
    public static $rank_to_start_auto_membership = 1; //taurus coordinator
    ...
    public function is_qualified_distributor()
    {
        ...
        //direct_lines
        $direct_left_line = $this->all_downlines_by_path('enrolment', false)->where('introduced_by', $this->mlm_id);
    ...
    public function getsubscriptionAttribute()
    {
        ...
        $expiry_time = strtotime("+2 days"); // since no membership cannot expire
