...
<div class="app-content content">
  <div class="content-wrapper">
    ...
    <datalist id="my_downlines">
      <option value="taiwo">Taiwo tuneed</option>
    </datalist>
        ...
        <div class="card-header">
          ...
          <div class="input-group col-6">
              ...
              <div class="input-group-append" id="button-addon2">
                <button class="btn " style="" type="submit">Go</button>
              </div>
          </div>
            </form>
          ...
          <div class="heading-elements">
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item text-success" href="<?=domain;?>/genealogy/placement/<?=$auth->username;?>/binary/2"> 
                  <i class="fa fa-sitemap text-success"></i> My Genealogy </a>
                <a class="dropdown-item text-success" href="<?=domain;?>/genealogy/last/0/<?=$tree_key;?>"> <i class="text-success ft-chevrons-left"></i> Last Left</a>
                <a class="dropdown-item text-success" href="<?=domain;?>/genealogy/last/1/<?=$tree_key;?>"><i class="text-success ft-chevrons-right"></i>Last Right</a>
                <a href="#" id="gfilter" class="dropdown-item text-success"  class="text-center">

                  <i class="ft-corner-left-up text-success" ></i>
                  <label class="text-success">Level up</label>
        ...
        <div class="card-content">
          <div class="card-body">
            ...
            <script>
              ...
              $.ajax({
                type: "POST",
                url: $base_url+"/genealogy/fetch/<?=$user_id;?>/<?=$tree_key;?>/3",
                data: null,
