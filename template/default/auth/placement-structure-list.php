                              ...
                              <div class="table-responsive">
                                  ...
                                  <tbody>
                                    <?php foreach ($list['list'] as $key => $downline):
                                      $pack = v2\Models\InvestmentPackage::for($downline->id)->latest()->first();

                                      ?>
                                    <tr>
                                      <td><a href="<?=domain;?>/genealogy/placement_list/<?=$downline->username;?>/1/<?=$tree_key;?>">
                                      <?=$downline->username;?> </a></td>
                                      <td><?=$downline->DisplayGender;?></td>
                                      <td><?=$downline->subscription->payment_plan->name;?></td>
                                      <td><?=$pack->ExtraDetailArray['investment']['name']??'Nil';?></td>
